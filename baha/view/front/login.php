		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST">
					...
					<p class="text--center"><a href="forgotpwd.php">Mot de passe oublié?</a> </p>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" id="login-box"  action="" method="POST">
					...
					<label for="login__confirmpassword"  style="height:50px">
						<span class="label-input100">Mot de passe</span></label>
					...
					<input type="button" value="Modifier" onclick="submitForm()" style="background-color: #198ae3;color: var(--loginSubmitColor);font-weight: 700;text-transform: uppercase;border-radius: var(--loginBorderRadus);padding: 1rem;width: 100%;cursor: pointer;">
